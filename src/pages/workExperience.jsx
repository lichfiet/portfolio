            ...
            <div className="container p-6 max-w-med mx-auto bg-neutral-200 rounded-xl shadow-xl">
                ...
                <div className="p-2">
                    <div id="work-lightspeed" className="grid" style={{ gridTemplateColumns: "1fr 50fr" }}>
                        ...
                        <div className="p-2">
                            <h1 className="text-l font-bold">Lightspeed DMS LLC.</h1>
                            <p className="text-sm md:text-base font-medium">Customer Support Analyst II</p>
                            <p className="text-sm md:text-base font-light italic">Aug. 2022 - Now</p>
                            <p className="p-2 text-sm md:text-base mb-3">
                                ...
                                contributing to technical documentation. Provide support to our largest clients, including training,
                                technical advice, and in depth software troubleshooting.
                            </p>
                            <p className="text-sm md:text-base font-medium">Customer Support Analyst I</p>
                            <p className="text-sm md:text-base font-light italic">Aug. 2022 - Now</p>
                    ...
                    <div id="work-starbucks" className="grid mt-5" style={{ gridTemplateColumns: "1fr 50fr" }}>
                        <div className="bg-black w-0.5 mt-3 mb-3">
                        </div>
                        <div className="p-2">
                            <h1 className="text-l font-bold">Starbucks Coffee Company</h1>
                            <p className="text-sm md:text-base font-medium">Customer Support Analyst II</p>
